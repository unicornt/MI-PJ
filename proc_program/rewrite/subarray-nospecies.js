...
codealchemist_log_type_pre('-2286266071861084579', ({v0 : ((typeof BenchmarkSuite) != ('undefined')) ? (BenchmarkSuite) : (undefined)}));
new BenchmarkSuite('SubarrayNoSpecies', [], []);
codealchemist_log_type_post('-2286266071861084579', ({v0 : ((typeof BenchmarkSuite) != ('undefined')) ? (BenchmarkSuite) : (undefined)}));
...
codealchemist_log_type_pre('4974749235498374538', ({v2 : ((typeof arr) != ('undefined')) ? (arr) : (undefined)}));
function subarray(){
codealchemist_log_type_pre('5541694836273874092', ({v1 : ((typeof arr) != ('undefined')) ? (arr) : (undefined)}));
(new_arr) = arr.subarray(1, - 1);
codealchemist_log_type_post('5541694836273874092', ({v1 : ((typeof arr) != ('undefined')) ? (arr) : (undefined), v0 : ((typeof new_arr) != ('undefined')) ? (new_arr) : (undefined)}));
}
codealchemist_log_type_post('4974749235498374538', ({}));
